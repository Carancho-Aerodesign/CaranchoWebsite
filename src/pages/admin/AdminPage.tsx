...
    const handleMemberSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            if (memberImageFile) {
                if (editingId) {
                    await deleteFileFromStorage(memberForm.img);
                }
